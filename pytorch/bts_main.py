...
def online_eval(model, dataloader_eval, gpu, ngpus,global_step, args):
    ...
    for _, eval_sample_batched in enumerate(tqdm(dataloader_eval.data)):
        with torch.no_grad():
            ...
            if not has_valid_depth:
                ...
                continue
            _, _, _, _, pred_depth = model(image, focal,args.att_rank)
    ...
    if withwandb:
        wandb.log(
            {"abs_rel": eval_measures_cpu[1], "sq_rel": eval_measures_cpu[4], "rms": eval_measures_cpu[3], "log_rms": eval_measures_cpu[5], "d1": eval_measures_cpu[6], "d2": eval_measures_cpu[7], "d3": eval_measures_cpu[8]},
            step=global_step)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    optimizer = torch.optim.AdamW([{'params': model.module.encoder.parameters(), 'weight_decay': args.weight_decay},
                                   ...
                                   {'params': model.module.AttentionGraphCondKernel.parameters(), 'weight_decay': 0},
                                   ],
