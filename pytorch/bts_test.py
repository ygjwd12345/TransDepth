...
def test(params):
    ...
    with torch.no_grad():
        for _, sample in enumerate(tqdm(dataloader.data)):
            ...
            # Predict
            print(i)
            lpg8x8, lpg4x4, lpg2x2, reduc1x1, depth_est = model(image, focal,args.att_rank)
    ...
    for s in tqdm(range(num_test_samples)):
        ...
        if args.save_lpg:
            ...
            #         plt.imsave(filename_cmap_png, (pred_depth), cmap='Greys')
            #         filename_lpg_cmap_png = filename_cmap_png.replace('.png', '_8x8.png')
        ...
        # colorVal = scalarMap.to_rgba(pred_depth)
        # filename_lpg_cmap_png = filename_cmap_png
        # plt.imsave(filename_lpg_cmap_png, colorVal)
        # colorVal = scalarMap.to_rgba(pred_1x1)
        # filename_lpg_cmap_png = filename_cmap_png.replace('.png', '_1x1.png')
        # plt.imsave(filename_lpg_cmap_png, colorVal)
        # colorVal = scalarMap.to_rgba(pred_2x2)
        # filename_lpg_cmap_png = filename_cmap_png.replace('.png', '_2x2.png')
        # plt.imsave(filename_lpg_cmap_png, colorVal)
        # colorVal = scalarMap.to_rgba(pred_4x4)
        # filename_lpg_cmap_png = filename_cmap_png.replace('.png', '_4x4.png')
        # plt.imsave(filename_lpg_cmap_png, colorVal)
        # colorVal = scalarMap.to_rgba(pred_8x8)
        # filename_lpg_cmap_png = filename_cmap_png.replace('.png', '_8x8.png')
        # plt.imsave(filename_lpg_cmap_png, colorVal)
